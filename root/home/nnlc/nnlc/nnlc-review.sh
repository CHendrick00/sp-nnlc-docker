...
while IFS= read -r line; do
  ...
  rm -r $review_rlog_route_dir/*.zst $review_dir/*.lat $review_dir/*.csv $review_dir/*.feather $review_dir/*.png $review_dir/latfiles.txt $review_dir/plots_torque $review_dir/plots > /dev/null 2>&1
